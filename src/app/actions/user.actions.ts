...
import { LOADING_STATUS, User, UsersData } from '../reducers/app.states';

export const LoadUsers = createAction('[USER] Get All', props<{ page: number }>());
export const LoadUsersSuccess = createAction('[USER] Get Success', props<UsersData>());
...
export const LoadingChange = createAction('[USER] Loading Status Change', props<{ loading: LOADING_STATUS}>());
